...
global.swisscalc.lib.operatorCache.PiMultiplicationOperator = new global.swisscalc.lib.operator(
	global.swisscalc.lib.operator.ARITY_UNARY, global.swisscalc.lib.operator.ASSOCIATIVITY_NONE, 0, 0, false, false, function(sy) {
...
global.swisscalc.lib.operatorCache.FactorialOperator = new global.swisscalc.lib.operator(
	global.swisscalc.lib.operator.ARITY_UNARY, global.swisscalc.lib.operator.ASSOCIATIVITY_NONE, 0, 1, false, false, function(sy) {
		var op = parseInt(sy.popOperand());
		var factorial = 1;
		for (let loopCounter=op; loopCounter>0; loopCounter--){
