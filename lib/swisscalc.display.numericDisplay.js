...
global.swisscalc.display.numericDisplay.prototype.addSymbol = function(digit, isOperator) {
	if(isOperator){
		if(this._canUseOperator){
			this._display+=digit;
			this._canUseOperator = false;
		}
	}
